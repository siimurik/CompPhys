...
c       $ gfortran -O2 dr_rodas.f rodas.f decsol.f dc_decsol.f -o decrod
c       $ gfortran -O2 dr_rodas.f rodas.f lapack.f lapackc.f dc_lapack.f -o laprod
c NOTE!
c Even with second level compiler optimization, the 'decsol'
c SUBROUTINE is faster than using 'lapack' SUBROUTINES.
        PROGRAM main
