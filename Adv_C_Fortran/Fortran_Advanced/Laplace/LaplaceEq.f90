!*************************************************************
! PROGRAM LAPLACE_EM
! Computes the electrostatic potentia laround conductors.
...
! laplace()
    ...
    print *, 'Compiling and running is done with the commands:'
    print *, '> gfortran LaplaceEq.f90 -o lf'
    print *, '> ./lf'
    print *, 'Enter V1, V2 :'
    print *, '100 -100'
    print *, 'Enter epsilon :'
    ...
    print *, 'gnuplot> splot "data" with lines'
    print *, ''
...
! INPUT:
! integer L: Linearsize of lattice
...
! on a 2-dimensional square lattice of linear size L.
...
subroutine laplace(V, isConductor, L, epsilon)
    ...
    do while (.TRUE.)!aninfiniteloop:
        error  = 0.0D0!Exitwhenerror<epsilon
        do j = 2, L-1
            do i = 2, L-1
